  ...
  return (
    <div className="space-y-2">
      <Label htmlFor="agent_name" className="text-sm font-medium text-gray-900">
        Assistant Name {isClientView && <span className="text-red-500">*</span>}
      </Label>
      <Input
        id="agent_name"
        {...register("agent_name")}
      ...
      {!isClientView && (
        <p className="text-xs text-gray-500 mt-1">Optional - "Assistant" will be used if not specified. Client can set this later. Do not use quotes.</p>
      )}
    </div>
  );
};
