  ...
  return (
    <>
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{total_interactions}</div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{average_response_time}s</div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{top_queries.length}</div>
        </CardContent>
      </Card>
    </>
  );
