...
SET storage_url = REPLACE(storage_url, '/public/documents/', '/public/document-storage/')
WHERE storage_url LIKE '%/public/documents/%';

-- Update document URLs in document_processing_jobs table
UPDATE document_processing_jobs
SET document_url = REPLACE(document_url, '/public/documents/', '/public/document-storage/')
