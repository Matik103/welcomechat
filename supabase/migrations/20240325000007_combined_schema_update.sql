...
DROP POLICY IF EXISTS "Users can view their own AI agents" ON ai_agents;
DROP POLICY IF EXISTS "Users can create their own AI agents" ON ai_agents;
DROP POLICY IF EXISTS "Users can update their own AI agents" ON ai_agents;
DROP POLICY IF EXISTS "Users can delete their own AI agents" ON ai_agents;
